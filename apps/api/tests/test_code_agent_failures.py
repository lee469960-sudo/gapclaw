...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("workspace_snapshot_identity_invalid", "workspace_integrity_error"),
        ("workspace_baseline_drift", "workspace_integrity_error"),
        ("workspace_integrity_metadata_error", "workspace_integrity_error"),

...
_ALIASES = {
    ...
    "workspace_snapshot_identity_invalid": FailureReason.WORKSPACE_INTEGRITY_ERROR,
    "workspace_baseline_drift": FailureReason.WORKSPACE_INTEGRITY_ERROR,
    "workspace_integrity_metadata_error": FailureReason.WORKSPACE_INTEGRITY_ERROR,

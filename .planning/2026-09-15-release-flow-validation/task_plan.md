...
| Browser automation failed before opening GitHub Actions secrets UI | 1 | CUA runtime failed during initialization; use manual GitHub UI update or an authorized API token instead. |

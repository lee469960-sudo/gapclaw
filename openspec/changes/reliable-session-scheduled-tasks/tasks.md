...
- [ ] 6.4 Run `openspec validate reliable-session-scheduled-tasks --strict` and the project `opsx:verify` process (implementation, regression, compatibility and rollback risk); verify all findings are resolved or explicitly accepted before archive.
